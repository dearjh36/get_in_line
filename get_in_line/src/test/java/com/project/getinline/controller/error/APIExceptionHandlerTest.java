...
class APIExceptionHandlerTest {
    ...
    void givenSpringException_whenHandlingApiException_thenReturnsResposeEntity(Exception e, HttpStatus httpStatus){
        // Given
    ...
    static Stream<Arguments> givenSpringException_whenHandlingApiException_thenReturnsResposeEntity(){
